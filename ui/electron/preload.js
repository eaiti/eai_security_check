...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  manageDaemon: (action, config) =>
    ipcRenderer.invoke("manage-daemon", action, config),
  installGlobally: () => ipcRenderer.invoke("install-globally"),
  uninstallGlobally: (removeConfig) =>
    ipcRenderer.invoke("uninstall-globally", removeConfig),
  ...
  loadApplicationConfig: () => ipcRenderer.invoke("load-application-config"),
  saveApplicationConfig: (config) => ipcRenderer.invoke("save-application-config", config),
});
