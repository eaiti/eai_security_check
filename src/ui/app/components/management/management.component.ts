  ...
  template: `
    <div class="management-container">
      <div class="management-header">
        <h1>🎛️ Management</h1>
        <p>
          Configure security settings, manage daemon services, and edit
          configuration files
        </p>
      </div>
        ...
        <div class="user-form">
          <div class="form-group">
            ...
            <small class="form-help"
              >This identifier will be included in all security reports for
              tracking purposes.</small
            >
          </div>
...
export class ManagementComponent implements OnInit {
  ...
  protected readonly selectedPlatform = signal<"linux" | "macos" | "windows">(
    "linux",
  );
