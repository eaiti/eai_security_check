...
import { ReportVerificationComponent } from "./components/report-verification/report-verification";
...
export const routes: Routes = [
  ...
  { path: "report-verification", component: ReportVerificationComponent },
